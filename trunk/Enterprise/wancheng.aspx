<%@ Page Title="" Language="C#" MasterPageFile="~/Master/ETC.Master" AutoEventWireup="true" CodeBehind="wancheng.aspx.cs" Inherits="ETC.Enterprise.wancheng" %>
            ...
            <td width="250" align="left" valign="top">
                <div id="lmenu">
                    <dl id="gallery">
                        <dt>合作企业
                            <dd>
                                <a href="tianqu.html" target="ifrRight">万城集团</a></dd>
                        </dt>
                    </dl>
                </div>
            </td>
